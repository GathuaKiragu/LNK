package com.tech.social.lnk.adapters.searchFriends;
...
public class SearchFriendAdapter extends RecyclerView.Adapter<SearchFriendAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder,int position) {
        ...
        holder.exist_icon.setOnClickListener(view -> {
            ...
            dialog.setMessage("This icon is shown to indicate that connection request to this user has been sent already.");
        ...
        holder.friend_icon.setOnClickListener(view -> {
            final AlertDialog.Builder dialog = new AlertDialog.Builder(context);
            dialog.setTitle("Information");
            dialog.setMessage("This icon is shown to indicate that the user is already your connection.");

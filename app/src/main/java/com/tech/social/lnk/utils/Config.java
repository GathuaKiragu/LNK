...
public class Config {
    ...
    public static final String NEWS_API_KEY = "4f24886253b24dfba5c3e6df95c96192";
    ...
    public static void createNotificationChannels(Context context){
        ...
        notificationChannelGroups.add(new NotificationChannelGroup("lnk","LNK"));
        ...
        flash_message_channel.setGroup("lnk");
        ...
        hify_other_channel.setGroup("lnk");

package com.tech.social.lnk.adapters.addFriends;
...
import com.tech.social.lnk.models.Friends;
...
public class AddFriendAdapter extends RecyclerView.Adapter<AddFriendAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.listenerText.setText("Add as connection");
        ...
        holder.exist_icon.setOnClickListener(view -> {
            ...
            dialog.setMessage("This icons shows to indicate that connection request to this user has been sent already.");
        ...
        holder.friend_icon.setOnClickListener(view -> {
            final AlertDialog.Builder dialog = new AlertDialog.Builder(context);
            dialog.setTitle("Information");
            dialog.setMessage("This icons shows to indicate that the user is already your connection.");
    ...
    public void removeItem(final int position, final Snackbar snackbar, final int deletedIndex, final Friends deletedItem) {
        ...
        new DialogSheet(context)
                ...
                .setMessage("Are you sure do you want to add " + usersList.get(position).getName() + " to your connection list?")
                                ...
                                .addOnSuccessListener(documentSnapshot1 -> {
                                    ...
                                    if(holderr.friend_icon.getVisibility()!=View.VISIBLE) {
                                        ...
                                        if (!documentSnapshot1.exists()) {
                                            ...
                                            Snackbar.make(view, "Connection request has been sent already", Snackbar.LENGTH_LONG).show();
                                            notifyDataSetChanged();
                                        }

                                    }else{
                                        Snackbar.make(view, usersList.get(position).getName()+" is already your connection", Snackbar.LENGTH_LONG).show();
                                        notifyDataSetChanged();
                                    }
                                ...
                                FirebaseFirestore.getInstance()
                                        ...
                                        .addOnSuccessListener(aVoid1 -> {
                                            ...
                                            holder.exist_icon.animate()
                                                    ...
                                                    .alpha(1.0f)
                                                    .start();
                                            Snackbar.make(view, "Connection request sent to " + deletedItem.getName(), Snackbar.LENGTH_LONG).show();
                                            notifyDataSetChanged();

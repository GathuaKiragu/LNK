package com.tech.social.lnk.adapters.viewFriends;
...
import com.tech.social.lnk.models.ViewFriends;
...
public class ViewFriendAdapter extends RecyclerView.Adapter<ViewFriendAdapter.ViewHolder> {
    ...
    public void removeItem(final int position) {
        ...
        new DialogSheet(context)
                .setTitle("Disconnect " + usersList.get(position).getName())
                .setMessage("Are you sure do you want to remove " + usersList.get(position).getName() + " from your connection list?")

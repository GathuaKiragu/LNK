...
import com.tech.social.lnk.adapters.addFriends.RecyclerViewTouchHelper;
import com.tech.social.lnk.adapters.searchFriends.SearchFriendAdapter;
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
                if (viewHolder instanceof SearchFriendAdapter.ViewHolder) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(findViewById(R.id.layout), "Connection request sent to " + name, Snackbar.LENGTH_LONG);
